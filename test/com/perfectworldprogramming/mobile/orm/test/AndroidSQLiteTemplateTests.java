 ...
 */
public class AndroidSQLiteTemplateTests extends ActivityInstrumentationTestCase2<Main>
{
    ...
    public void setUp()
    {
        helper = new DBHelper(this.getInstrumentation().getContext(), new Class[] { Person.class, Address.class, Account.class }, "ormtest.db", 3);
    ...
    public void testSuccessInsertWithDomainObject()
    {
        ...
        cursor.moveToFirst();
        assertEquals("Ryan", cursor.getString(cursor.getColumnIndex(Person.COL_FIRST_NAME)));
    ...
    public void testFailureInsertWithDomainObject()
    {
        ...
        {
            fail("This should throw a Spring DataAccessException not one from SQLite: "+e.getClass()+": "+e.getMessage());
        }
    }
    ...
    public void testSuccessInsertSQL()
    {
        ...
        assertEquals(1, cursor.getCount());
        cursor.moveToFirst();
        assertEquals("Bugs", cursor.getString(cursor.getColumnIndex(Person.COL_FIRST_NAME)));
    ...
    public void testSuccessUpdateSQL()
    {
        ...
        args[1] = "Business";
        template.update(sql, args);
        sql = "Select " + Account.COL_AMOUNT + " from Account where " + Account.COL_ACCOUNT_TYPE + "='Business'";
    ...
    public void testSuccessQueryForObjectWithCursorRowMapper()
    {
        ...
        // AddressCursorRowMapper addressCursorRowMapper = new
        // AddressCursorRowMapper();
        Address address = template.queryForObject(sql, Address.class, "12345");
    ...
    // args = "John";
    // try {
    // template.queryForObject(sql, Address.class, args);
    ...
    public void testFailureQueryForObjectWithCursorExtractor()
    {
        ...
        {
            fail("Only an IllegalArgumentException should be thrown, not " + e.getClass().getName());
        }
    ...
    {
        List<Person> people = template.query("Select * from Person Where FIRST_NAME='?'", Person.class, "John");
    ...
    {
        List<Person> people = template.query("Select * from Person Where FIRST_NAME='?'", Person.class, "Jonathon");
        assertNotNull(people);
    ...
    public void testSuccessQueryWithCursorRowMapper()
    {
        ...
        // CursorRowMapper<Person> personCursorRowMapper = new
        // PersonCursorRowMapper();
        String sql = sqlStart + " FIRST_NAME='?'";
        List<Person> people = template.query(sql, Person.class, "John");
        ...
        List<Person> everyone = template.query("Select * from Person", Person.class);
    ...
    // String sql = sqlStart + " FIRST_NAME=?";
    // try {
    // template.query(sql, Person.class, "John");
    ...
    //
    // try {
    // template.query("Select * from Address", Person.class);
